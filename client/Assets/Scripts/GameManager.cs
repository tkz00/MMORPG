...
public class GameManager : MonoBehaviour
{
    ...
    private void UpdateCharacterAnimations(CharacterDTO characterDTO, Character character)
    {
        ...
        {
            if (characterDTO.action != null) character.HandleActionFeedback((CharacterAction)characterDTO.action, characterDTO.actionDurationMs);
    ...
    void UpdateNPCsPositions(List<CharacterDTO> npcDTOS)
    {
        foreach (CharacterDTO npcDTO in npcDTOS)
        {
            ...
            if (npcDTO.action != null) npc.HandleActionFeedback((CharacterAction)npcDTO.action, npcDTO.actionDurationMs);
